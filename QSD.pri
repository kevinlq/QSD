!isEmpty(QTCREATOR_PRI_INCLUDED):error("QSD.pri already included")

#QTCREATOR_VERSION = 4.6.1
#QTCREATOR_COMPAT_VERSION = 4.6.0
#VERSION = $$QTCREATOR_VERSION
#QTCREATOR_DISPLAY_VERSION = 4.6.1
#QTCREATOR_COPYRIGHT_YEAR = 2018
#BINARY_ARTIFACTS_BRANCH = 4.6

isEmpty(IDE_DISPLAY_NAME):           IDE_DISPLAY_NAME = Qt Demo
isEmpty(IDE_ID):                     IDE_ID = qtdemo
isEmpty(IDE_CASED_ID):               IDE_CASED_ID = QtDemo
